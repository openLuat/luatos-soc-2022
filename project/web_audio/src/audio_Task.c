...
/*
*demo Ĭ�ϵ���780E���������Ƶ����С��
*ʹ�������ȿ�������Ҫ�� air780e_tm8211 �ĺ���1��Ĭ�Ϲر�
*ʹ������DAC���ţ���Ҫ��soft_dac �����ţ��ر�air780e_tm8211�ĺ�
*/
/*-------------------------------------------------audio define-----------------------------------------------*/
static osEventFlagsId_t waitAudioPlayDone = NULL;
static HANDLE g_s_delay_timer;
#define soft_dac 0 //֧��ͨ��DAC���Ų���
...
void audio_task(void *param)
{
    ...
    else
    {
        if (1 == air780e_tm8211)
        {
            luat_i2s_base_setup(0, I2S_MODE_MSB, I2S_FRAME_SIZE_16_16); // �����ȿ�����TM8211
        }
        else
        {
            // air780E +��ƵС��
...
void audio_task_init(void)
{
    ...
    if ((1 == air780e_tm8211) || (1 == soft_dac))//ʹ��tm8211 soft_dac ���Ŷ���Ҫ��PA�Ŀ�������
    {
