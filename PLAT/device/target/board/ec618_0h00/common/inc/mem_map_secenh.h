...
#ifndef MEM_MAP_AUTHFOTA_H
#define MEM_MAP_AUTHFOTA_H
...
0x00000000          |---------------------------------|
                    |      header1 4KB                |-----bootloader1 header
0x00001000          |---------------------------------|
                    |      header2 4KB                |-----bootloader2 header
0x00002000          |---------------------------------|
                    |      header3 4KB                |-----sysimg header
0x00003000          |---------------------------------|
                    |      resv    4KB                |
0x00004000          |---------------------------------|
                    |      bootloader1 32KB           |
...
#define BOOTLOADER_FLASH_LOAD_SIZE      (0x8000)//32kB

//bl2 addr and size
#define BOOTLOADER2_FLASH_LOAD_ADDR      (0x0080c000)
#define BOOTLOADER2_FLASH_LOAD_SIZE      (0x18000)//96kB
...
#define BLU_SEC_HAED_ADDR               (0x1000)
#define BLU_FLASH_LOAD_SIZE             (0x1000)
